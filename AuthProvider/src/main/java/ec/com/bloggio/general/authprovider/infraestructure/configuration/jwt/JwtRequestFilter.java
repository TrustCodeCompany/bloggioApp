...
import ec.com.bloggio.general.authprovider.domain.commons.FeignClientInterceptor;
...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	public JwtRequestFilter(JwtTokenUtil jwtTokenUtil, FeignClientInterceptor feignClientInterceptor) {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		if (requestTokenHeader != null && requestTokenHeader.startsWith(BEARER)) {
			...
			logger.info("Token receive id {}",jwtToken);
			try {
				feignClientInterceptor.setjwtToken(jwtToken);
